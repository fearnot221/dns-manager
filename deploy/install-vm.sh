...
echo '3. Owner: verified NCU identity details.name=115502532, independent of stored role; Portal users sign up automatically as USER. Assign admins manually.'
