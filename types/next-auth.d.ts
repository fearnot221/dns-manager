...
declare module "next-auth/jwt" { interface JWT { logtoIdToken?:string; idleSessionId?:string; idleExpiresAt?:number; portalEmail?:string; loginProvider?:string; userId?:string; globalRole?:"USER"|"ADMIN"|"SUPER_ADMIN" } }
