...
export const config={matcher:["/contact/:path*","/inspections/:path*","/dashboard/:path*","/requests/:path*","/units/:path*","/zones/:path*","/activity/:path*","/admin/:path*","/inventory/:path*","/api/:path*"]};
