...
const env = { ...process.env, DEPLOY_TAG: 'verification', POSTGRES_PASSWORD: randomBytes(32).toString('hex'), AUTH_SECRET: randomBytes(32).toString('hex'), SETTINGS_ENCRYPTION_KEY: randomBytes(32).toString('hex'), AUTH_URL: 'https://dns-test.example.invalid', WEB_PORT: '0', PDNS_MOCK: 'true', PDNS_API_URL: '', PDNS_API_KEY: '', AUTH_LOGTO_SECRET: '', NCU_PORTAL_CLIENT_ID: '', NCU_PORTAL_CLIENT_SECRET: '', NCU_OWNER_IDENTIFIER: '', GOOGLE_CLIENT_ID: '', GOOGLE_CLIENT_SECRET: '', OWNER_INITIAL_PASSWORD: randomBytes(24).toString('hex') };
