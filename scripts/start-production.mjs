...
export function validateProductionEnvironment(env) {
  ...
  if (!!env.NCU_PORTAL_CLIENT_ID !== !!env.NCU_PORTAL_CLIENT_SECRET) throw new Error("Both NCU_PORTAL_CLIENT_ID and NCU_PORTAL_CLIENT_SECRET are required");
  if (env.NCU_PORTAL_CLIENT_ID && !env.NCU_OWNER_IDENTIFIER) throw new Error("NCU_OWNER_IDENTIFIER must be explicitly verified and configured before enabling Portal");
