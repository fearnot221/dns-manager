...
export function UsersWorkbench() {
  ...
  const rows = (data?.users || []).filter((u) => `${u.email || ""} ${u.studentId || ""} ${u.name} ${u.account} ${u.note}`.toLowerCase().includes(query.trim().toLowerCase()));
