...
export interface Actor { id:string; email:string; name?:string|null; portalIdentifier?:string|null; studentId?:string|null; globalRole:GlobalRole; zoneRoles:Record<string,ZoneRole>; }
