...
export interface Actor { id:string; email:string; portalEmail?:string|null; name?:string|null; portalIdentifier?:string|null; studentId?:string|null; globalRole:GlobalRole; zoneRoles:Record<string,ZoneRole>; }
